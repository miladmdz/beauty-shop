...
import Details from "@/components/templates/Categories/Details";
import Road from "@/components/templates/Categories/road";
...
function page() {
  ...
  return (
    <>
      <NavBar />
      <Road route={"محصولات مراقبت از پوست/کرم ضد لک"} />
